...
namespace AIO.IDOS3.Client.Mobile.Models
{
    ...
    public class EditBaseOptions<T> : BindableErrorBase
    {
        ...
        private IconVisibility clearIconVisibility = IconVisibility.Auto;
        public IconVisibility ClearIconVisibility { get { return clearIconVisibility; } set { SetProperty(ref clearIconVisibility, value); } }
