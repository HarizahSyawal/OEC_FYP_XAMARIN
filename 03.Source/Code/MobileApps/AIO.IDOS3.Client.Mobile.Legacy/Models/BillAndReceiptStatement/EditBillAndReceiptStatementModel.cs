...
namespace AIO.IDOS3.Client.Mobile.Models
{
    ...
    public class EditBillAndReceiptStatementModel : BindableErrorBase
    {
        ...
        public mvBillAndReceiptStatement data = null;
        public mvBillAndReceiptStatement Data { get { return data; } set { SetProperty(ref data, value); } }
        ...
        private ObservableCollection<mvBillAndReceiptStatementDetails> childDetails = new ObservableCollection<mvBillAndReceiptStatementDetails>();
        public ObservableCollection<mvBillAndReceiptStatementDetails> ChildDetails { get { return childDetails; } set { SetProperty(ref childDetails, value); } }
