...
namespace AIO.IDOS3.Client.Mobile.Models
{
    ...
    public class EditSalesOrderSummaryModel : BindableErrorBase
    {

        #region Constructors

        public EditSalesOrderSummaryModel()
        {
        ...
        private mvSalesOrderSummary salesOrderSummary = null;
        public mvSalesOrderSummary SalesOrderSummary { get { return salesOrderSummary; } set { SetProperty(ref salesOrderSummary, value); } }
