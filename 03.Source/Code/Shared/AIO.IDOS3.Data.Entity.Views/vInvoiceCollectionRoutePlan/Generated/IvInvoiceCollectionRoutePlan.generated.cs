...
// Description   : IvInvoiceCollectionRoutePlan partial interface.
//
// NOTE: This file is generated by system. Please do not modify this file.
//       Consider regenerate or modify through partial interface. If required,
//       a partial interface should be created as 'IvInvoiceCollectionRoutePlan.cs'
...
namespace AIO.IDOS3.Data.Entity
{
    ...
    public partial interface IvInvoiceCollectionRoutePlan
    {                
        ...
        int? RefPrintCount { get; set; }
        System.DateTime? RefLastPrintedDate { get; set; }
        int? RefDocumentStatusID { get; set; }
        string RefDocumentStatusName { get; set; }
        string RefDocumentStatusReason { get; set; }
        string RefMobileDocumentCode { get; set; }
        System.DateTime? RefPostedDate { get; set; }
        ...
        string OpnameDocumentCode { get; set; }
        System.DateTime? OpnameTransactionDate { get; set; }
        ...
        bool RoutePlanWeek1 { get; set; }
        bool RoutePlanWeek2 { get; set; }
        bool RoutePlanWeek3 { get; set; }
        bool RoutePlanWeek4 { get; set; }
        bool RoutePlanDay1 { get; set; }
        bool RoutePlanDay2 { get; set; }
        bool RoutePlanDay3 { get; set; }
        bool RoutePlanDay4 { get; set; }
        bool RoutePlanDay5 { get; set; }
        bool RoutePlanDay6 { get; set; }
        bool RoutePlanDay7 { get; set; }

        #endregion

        #region Methods
        
        void CopyFrom(IvInvoiceCollectionRoutePlan obj);
