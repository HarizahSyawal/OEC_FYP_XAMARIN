...
// Description   : IvStockTransferSummary partial interface.
//
// NOTE: This file is generated by system. Please do not modify this file.
//       Consider regenerate or modify through partial interface. If required,
//       a partial interface should be created as 'IvStockTransferSummary.cs'
...
namespace AIO.IDOS3.Data.Entity
{
    ...
    public partial interface IvStockTransferSummary
    {                
        ...
        int QtyHold { get; set; }
        int QtyBad { get; set; }
        string QtyTransferConvGood { get; set; }
        string QtyTransferConvHold { get; set; }
        string QtyTransferConvBad { get; set; }
        int? QtyTransferGood { get; set; }
        int? QtyTransferHold { get; set; }
        int? QtyTransferBad { get; set; }

        #endregion

        #region Methods
        
        void CopyFrom(IvStockTransferSummary obj);
