...
// Description   : vUserController class.
//
// Modified by   :
// Modified date :
// Comments      :
...
namespace AIO.IDOS3.Web.Services.Controllers.DataServices
{
    ...
    public class vUsersController : DataServiceController<vUser>
    {

        #region Constructors
                
        public vUsersController(ILogger<vUsersController> logger, MainDbContext context)
            : base(logger, context)
        {
        ...
        [EnableQuery]
        [HttpGet]
        public IQueryable<vUser> Get()
        {
            var viewProvider = context.GetDataViewProvider<vUserViewProvider>();
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] vUser obj)
        {
        ...
        [HttpPatch]
        public async Task<IActionResult> Patch([FromODataUri] int keyID, [FromBody] vUser obj)
        {
            return await Put(keyID, obj);
        }
        
        [HttpPut]
        public async Task<IActionResult> Put([FromODataUri] int keyID, [FromBody] vUser obj)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
