...
namespace Wismapi.Web.Security
{
    public abstract class BasicAuthProvider
    {
        ...
        {
            if (isSslRequired && !context.Request.IsHttps)
                return;

            context.User = (ClaimsPrincipal)AuthenticateRequest(context.Request.Headers);
        }
        ...
        protected virtual IPrincipal AuthenticateRequest(IHeaderDictionary requestHeaders)
        {
