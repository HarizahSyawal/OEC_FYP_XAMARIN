...
namespace Wismapi.Utilities
{
    ...
    public static class ConversionUtility
    {
        ...
        {
            return new DateTime(new DateTime(value.Year, value.Month, value.Day).AddDays(1).AddMilliseconds(-3).Ticks, value.Kind);
        }
        ...
        {
            return ToLastTimeOfDay(new DateTime(new DateTime(value.Year, value.Month, DateTime.DaysInMonth(value.Year, value.Month)).Ticks, value.Kind));
        }
