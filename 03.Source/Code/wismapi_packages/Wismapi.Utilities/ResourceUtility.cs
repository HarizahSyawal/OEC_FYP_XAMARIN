...
namespace Wismapi.Utilities
{
    ...
    public static class ResourceUtility
    {
        ...
        public static string GetRuntimeFormattedString(object resourceRuntimeType, string formatkey, params string[] paramKeys)
        {
        ...
        public static string GetRuntimeFormattedString(object formatResourceRuntimeType, string formatkey, object paramResourceRuntimeType, params string[] paramKeys)
        {
        ...
        public static string GetFormattedString(Type formatResourceType, string formatkey, Type paramResourceType, params string[] paramKeys)
        {
