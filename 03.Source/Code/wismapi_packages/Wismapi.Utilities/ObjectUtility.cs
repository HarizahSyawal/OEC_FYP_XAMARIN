...
namespace Wismapi.Utilities
{
    ...
    public static class ObjectUtility
    {
        ...
        public static TTarget CopyPropertyValues<TTarget>(object source, bool? useLocalDateTimeConversion, double? timeZoneOffset) where TTarget : new()
        {
            TTarget target = new TTarget();
        ...
        public static void CopyPropertyValues(object source, object target, bool? useLocalDateTimeConversion, double? timeZoneOffset)
        {
        ...
        {
            return GetPropertyType(typeof(TClass), propertyName);
        }
        ...
        public static object InvokePublicGenericMethod(object obj, string methodName, Type[] genericTypes, params object[] parameters)
        {
            return obj.GetType().GetMethod(methodName, BindingFlags.Public).MakeGenericMethod(genericTypes).Invoke(obj, parameters);
        }

        public static object InvokePrivateGenericMethod(object obj, string methodName, Type[] genericTypes, params object[] parameters)
        {
            return obj.GetType().GetMethod(methodName, BindingFlags.NonPublic).MakeGenericMethod(genericTypes).Invoke(obj, parameters);
        }
        ...
        public static object InvokePublicStaticGenericMethod(Type classType, string methodName, Type[] genericTypes, params object[] parameters)
        {
            return classType.GetMethod(methodName, BindingFlags.Public | BindingFlags.Static).MakeGenericMethod(genericTypes).Invoke(null, parameters);
        }
        ...
        public static object InvokePrivateStaticGenericMethod(Type classType, string methodName, Type[] genericTypes, params object[] parameters)
        {
            return classType.GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Static).MakeGenericMethod(genericTypes).Invoke(null, parameters);
        }
